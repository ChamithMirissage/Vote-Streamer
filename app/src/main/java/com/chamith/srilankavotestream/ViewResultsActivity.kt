...
import com.chamith.srilankavotestream.databinding.ActivityViewResultsBinding
import com.chamith.srilankavotestream.databinding.ItemViewDivisionResultBinding
...
//        enableEdgeToEdge()
        ...
        binding.textViewElectoralDistrict.text = resultJson.getString("electoralDistrict")
        binding.textViewPollingDivision.text = resultJson.getString("pollingDivision")
    ...
    private fun setItemViews(parties: JSONArray) {
        var itemView: ItemViewDivisionResultBinding = binding.itemViewParty1
        ...
        for (i in 0 until 5) {
            ...
            itemView.textViewPercentage.text =
                "${partyObject.getDouble("votePercentage")}%"
